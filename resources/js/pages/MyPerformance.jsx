        ...
        <div className="space-y-8 animate-in fade-in duration-700">
            <header className="flex flex-col md:flex-row md:items-end justify-between gap-4 bg-white p-8 rounded-3xl shadow-sm border border-slate-100 relative overflow-hidden">
                <div className="relative z-10">
                    <h2 className="text-3xl font-black text-neutral-900 tracking-tight mb-2">My Performance</h2>
                    <p className="text-neutral-500 font-medium">Historical KPI insights and assessment breakdown.</p>
                </div>
                <div className="flex items-center gap-3 relative z-10 bg-slate-50 p-2 rounded-2xl border border-slate-100">
                    <div className="w-12 h-12 rounded-xl bg-orange-600 flex items-center justify-center text-white shadow-lg shadow-indigo-200">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 space-y-8">
                    <section className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100">
                        <div className="flex items-center justify-between mb-8">
                            ...
                            <button className="text-sm font-bold text-orange-600 hover:text-indigo-700 transition-colors">Assessment History &rarr;</button>
                        </div>
                    ...
                    <section className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100">
                        ...
                        <div className="h-64 flex items-center justify-center bg-slate-50 rounded-2xl border-2 border-dashed border-neutral-200 text-neutral-400 font-medium">
                ...
                <div className="space-y-8">
                    <section className="bg-neutral-900 text-white p-8 rounded-3xl shadow-xl shadow-indigo-900/20 relative overflow-hidden">
                    ...
                    <section className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100">
                        ...
                        <button className="w-full py-4 bg-slate-50 text-slate-600 rounded-2xl text-sm font-bold hover:bg-slate-100 transition-all border border-neutral-200">
