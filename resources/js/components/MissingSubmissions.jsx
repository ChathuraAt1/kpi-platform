            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-slate-500 text-sm mt-1">
                        Track daily task log submissions across your team
                    </p>
                </div>
                <input
                    type="date"
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4">
                    ...
                    <div className="text-xs text-emerald-600 mt-2">
                        {total_employees > 0
                            ? (
                                  (submitted_count / total_employees) *
                                  100
                              ).toFixed(0)
                            : 0}
                        % completion
                ...
                <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                    ...
                    <div className="text-xs font-bold text-red-600 uppercase tracking-widest mt-1">
                        ✗ Missing
                    </div>
                ...
                <div className="bg-white rounded-lg border border-slate-100 shadow-sm overflow-hidden">
                    <div className="bg-emerald-50 border-b border-emerald-200 px-6 py-4">
                        <h4 className="font-bold text-emerald-900">
                            ✓ Submitted On Time ({submitted_count})
                        </h4>
                    </div>
                    <div className="overflow-x-auto">
                        <table className="w-full text-sm">
                            <thead className="border-b border-slate-100 bg-slate-50">
                                <tr>
                                    <th className="text-left px-6 py-3 font-bold text-slate-700">
                                        Employee
                                    </th>
                                    <th className="text-left px-6 py-3 font-bold text-slate-700">
                                        Submitted At
                        ...
                        <table className="w-full text-sm">
                            <thead className="border-b border-slate-100 bg-slate-50">
                                <tr>
                                    ...
                                    <th className="text-right px-6 py-3 font-bold text-slate-700">
                                        Minutes Late
                                    </th>
                                </tr>
                            </thead>
            ...
            {missing_count === 0 && late_count === 0 && (
                <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-8 text-center">
                    ...
                    <div className="text-emerald-700 text-sm mt-2">
                        Everyone has submitted their task logs on time.
                    </div>
                </div>
            )}
        </div>
